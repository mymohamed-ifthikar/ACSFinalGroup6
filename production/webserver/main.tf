...
resource "aws_s3_bucket" "s3" {
  bucket = "${var.prefix}-${var.env}-group6-images"
}
...
resource "aws_instance" "public_instance" {
  ...
  user_data = <<-EOF
   ...
   curl -o /var/www/html/canada.jpeg https://${aws_s3_bucket.s3.bucket}.s3.amazonaws.com/${aws_s3_bucket_object.object.key}

  # Create the HTML file with image reference
  echo "<html><body>" > /var/www/html/index.html
  echo "<h1>Welcome to our site! - Group6</h1>" >> /var/www/html/index.html
  echo "<img src=\"/canada.jpeg\">" >> /var/www/html/index.html
